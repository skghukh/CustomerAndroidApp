...
public class ScehuledTripDetailsActivity extends MapActivity {
    ...
    protected void initComponents() {
        ...
        initMap();
        clearAllMarkers();
        subscribeForSpecificDriverLocationUpdates(driverId);
        driverNameTextView = findViewById(R.id.driverName);
        vehicleRegistrationNo = findViewById(R.id.vehicleRegistrationNo);
        pickupLocationValue = findViewById(R.id.pickupLocationValue);
        driverMobNo = findViewById(R.id.callDriverValue);
        src_dst_long = findViewById(R.id.src_dst_long);
        pickupLocationDetails = findViewById(R.id.pickupLocationDetails);
        priceDistanceView = findViewById(R.id.price_dist_view);
        payment_mode_cancel_layout = findViewById(R.id.payment_mode_cancel_layout);
        pick_loc_val = findViewById(R.id.pick_loc_val);
        dest_loc_val = findViewById(R.id.dest_loc_val);
        ...
        subscribeForTripStatus(String.valueOf(ApplicationSettings.getCustomerEid(ScehuledTripDetailsActivity.this)), currentTripId);
    }
